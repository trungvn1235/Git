		...
		<dir class="table row">
			...
			<div class="col-md-12">
				<table class="table ">
					...
					?>
					<tr>
						<td><?php echo $rows['feedbackID']?></td>
						<td><?php echo $rows['phonenumber']?></td>
						<td><?php echo $rows['content']?></td>
						<td>
							<a href="./delete.php?feedbackID=<?php echo $rows['feedbackID'] ?>" onclick="return confirmAction()"><button type="button" class="btn btn-danger">Delete</button></a>
						</td>
					</tr>
					<?php
						}
