...
<body>
    ...
    <div class="container-fluid padding">
        <div class="row padding text-center">
            <div class="col-12">
                <div class="bg-outline-danger" style="margin-bottom:20%;padding-top:20%;background-color: rgb(237,32,91);">
                    <i class="fa fa-check" aria-hidden="true" style="color: red; font-size: 80px"></i>
                    <hr>
